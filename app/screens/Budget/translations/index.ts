...
interface TranslationKeys {
  ...
  BUDGET_SCREEN_NUMBER_OF_DAYS_VEGETARIAN_NICE_START: string;
  BUDGET_SCREEN_NUMBER_OF_DAYS_VEGETARIAN_WELL_DONE: string;
  BUDGET_SCREEN_NUMBER_OF_DAYS_VEGETARIAN_NO_MEAT_SO_FAR: string;
